...
| `transit.mjs` | 門 1 牆上 1／2／抹除位／4 缺格序列、門面 1～4 刻痕映射、跨來源推演、兩張 CanvasTexture、四組對照完整入鏡、側邊線索與中央走廊同時可見；門 1 → 門 2 過場、20 秒計時、7／11／14／20 秒站位、缺件脈衝、三條取件路徑、通電、死亡與重開（64 項） |
