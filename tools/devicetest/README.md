...
F0_URL=http://127.0.0.1:8100/index.html node tools/devicetest/door3-scene.mjs
```
...
| `door3-scene.mjs` | 門 3 十字揭露、工作檯正面操作位、直橫式控制讀表、四向視線與實體穿門；另驗證濕視野像素回歸、後鏈／左水波／右熄燈先提示後顯怪、嚴重錯誤只推進一站、拉桿凍結威脅，以及死亡整局重開 |
