...
- Door 2 正解提交、電磁鎖解開、開門、連續直線穿門、泵房接近與 Door 3 中心。
...
門 3 已先完成淹水十字泵房灰盒：Door 2 門後的積水連接廊與泵房使用同一組世界座標，開門時便能看見遠方泵房，玩家不轉向、不切黑地一路跑到十字中心。正面是防洪閘門與三缸壓力組，左／右／後分別以暖色粗管、冷色電纜、鐵鏈來區分方向；操作區收起後可用拖曳或 W/A/S/D 環視。這一輪沒有啟動怪物與水量規則，避免在空間尚未驗證前把兩套狀態機綁死。
