...
目前階段：**F2 門 3 場景與工作檯灰盒**（門 1、門 2 玩法已接通；門 2 成功後會進入可環視的淹水十字泵房。門 3 三缸液面／壓力工作檯已可操作，正式水量目標與三向怪物仍刻意保持凍結）
