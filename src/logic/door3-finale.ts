 ...
 *
 * This pass covers only F2.5.1 (floodgate slam/deformation) and F2.5.2
 * (black-face reveal). F2.5.3 will replace the temporary completion beat with
 * the second escape run.
 */
